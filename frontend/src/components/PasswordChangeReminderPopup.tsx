      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full overflow-hidden border border-slate-200">
        ...
        <div className="p-6 space-y-4">
          <p className="text-slate-700">
            ...
            Pensez à le mettre à jour pour garder votre compte sécurisé.
          </p>
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 w-full py-3 px-4 rounded-xl bg-slate-100 text-slate-800 font-medium hover:bg-slate-200 transition-colors border border-slate-200"
            >
            ...
            {showGenerated && generatedPassword && (
              <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-between gap-2">
                ...
                <button
                  ...
                  className="text-indigo-600 text-sm font-medium whitespace-nowrap"
                >
                  Copier
                </button>
              </div>
            ...
            >
              ...
              J'ai modifié mon mot de passe
            </button>
          </div>

          <p className="text-xs text-slate-500">
            En cliquant sur « J'ai modifié mon mot de passe », vous serez redirigé vers le formulaire
            de changement. Une fois modifié, ce rappel disparaîtra pour 6 mois.
          </p>
        </div>
      </div>
    </div>
