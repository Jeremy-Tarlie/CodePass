        ...
        {activeTab !== "forgotPassword" && (
          <div className="flex bg-gray-50 border-b border-gray-200">
            <button
              ...
              className={`flex-1 py-4 font-semibold ${activeTab === "connexion" ? "text-indigo-600 bg-white border-b-2 border-indigo-600" : "text-gray-500"}`}
            >
              Connexion
            </button>
            <button
              onClick={() => setActiveTab("register")}
              className={`flex-1 py-4 font-semibold ${activeTab === "register" ? "text-indigo-600 bg-white border-b-2 border-indigo-600" : "text-gray-500"}`}
            >
              Inscription
            </button>
          </div>
        ...
        <div className="p-6">
          {activeTab === "forgotPassword" ? (
            <div className="space-y-6">
              <button onClick={() => setActiveTab("connexion")} className="flex items-center gap-2 text-gray-600">
              ...
              <form onSubmit={handleForgotPassword} className="space-y-5">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 border rounded-lg ${forgotEmailError ? "border-red-500" : "border-gray-300"}`}
                ...
                <button type="submit" disabled={isSubmitting} className="w-full bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-700 font-semibold disabled:opacity-50">
                  Envoyer le lien
                </button>
              </form>
            </div>
              ...
              <form onSubmit={handleLoginSubmit} className="space-y-5">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 border rounded-lg ${loginEmailError ? "border-red-500" : "border-gray-300"}`}
                      placeholder="votre@email.com"
                      required
                    />
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" checked={loginRemember} onChange={(e) => setLoginRemember(e.target.checked)} className="w-4 h-4 text-indigo-600 rounded" />
                    <span className="text-sm text-gray-700">Rester connecté</span>
                  </label>
                  <button type="button" className="text-sm text-indigo-600 font-medium" onClick={() => { setActiveTab("forgotPassword"); setForgotEmail(loginEmail); }}>
                    Mot de passe oublié ?
                  </button>
                </div>
                <button type="submit" disabled={isSubmitting || isLoading} className="w-full bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-700 font-semibold disabled:opacity-50">
              ...
              <form onSubmit={handleRegisterSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 border rounded-lg ${registerEmailError ? "border-red-500" : "border-gray-300"}`}
                    placeholder="votre@email.com"
                    required
                  />
